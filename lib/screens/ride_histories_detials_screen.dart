...
class RidesHistoriesDetailsScreen extends StatefulWidget {
  ...
  const RidesHistoriesDetailsScreen(this.singleTrip, {Key? key}) : super(key: key);

  @override
  State<RidesHistoriesDetailsScreen> createState() => _RidesHistoriesDetailsScreenState();
}

class _RidesHistoriesDetailsScreenState extends State<RidesHistoriesDetailsScreen> {
